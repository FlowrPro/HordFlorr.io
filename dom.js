...
// --- DOM ---
// main canvas used for WebGL rendering (Three.js)
const canvas = document.getElementById('game');
// HUD canvas used for 2D overlay drawing (hotbar, HP bars, text)
...
state.dom = {
  ...
  hudCanvas,    // HUD overlay canvas
  ctx,          // HUD 2D context (for rendering UI)
